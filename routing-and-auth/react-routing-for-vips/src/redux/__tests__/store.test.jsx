...
describe("Redux Store", () => {
    ...
    it("should handle LOGIN action", () => {
        const action = { type: "LOGIN", payload: { id: 1, name: "Test User" } };
        const expectedState = { ...store.getState(), user: action.payload };
    ...
    it("should handle LOGOUT action", () => {
        ...
        const expectedState = { ...store.getState(), user: null, lastVisitedPages: [] };
